...
function useApolloClient() {
    const host = (protocol)=>`${protocol}${ true ? "s" : 0}://${"obs.jager-kujawa.com"}${process.env.NEXT_PUBLIC_PORT ? `:${process.env.NEXT_PUBLIC_PORT}` : ""}/api/${protocol === "http" ? "graphql" : "subscriptions"}`;

...
export type CampaignFragment = { __typename?: 'Campaign', id: string, name: string, gmInspiration: boolean, players: Array<{ __typename?: 'Player', id: string, playerName: string, characterName?: string | null, isGM: boolean, inspiration: number }> };

export type PlayerFragment = { __typename?: 'Player', id: string, playerName: string, characterName?: string | null, isGM: boolean, inspiration: number };
...
export type DeleteCampaignMutation = { __typename?: 'Mutation', campaign?: { __typename?: 'CampaignMutation', delete: boolean } | null };
...
export type DeletePlayerMutation = { __typename?: 'Mutation', player?: { __typename?: 'PlayerMutation', delete: boolean } | null };
...
export type SaveCampaignMutation = { __typename?: 'Mutation', campaign?: { __typename?: 'CampaignMutation', save: { __typename?: 'Campaign', id: string, name: string, gmInspiration: boolean, players: Array<{ __typename?: 'Player', id: string, playerName: string, characterName?: string | null, isGM: boolean, inspiration: number }> } } | null };
...
export type SavePlayerMutation = { __typename?: 'Mutation', player?: { __typename?: 'PlayerMutation', save: { __typename?: 'Player', id: string, playerName: string, characterName?: string | null, isGM: boolean, inspiration: number } } | null };
...
export type SetPlayerInspirationMutation = { __typename?: 'Mutation', player?: { __typename?: 'PlayerMutation', save: { __typename?: 'Player', id: string, playerName: string, characterName?: string | null, isGM: boolean, inspiration: number } } | null };

export type ListCampaignsQueryVariables = Exact<{ [key: string]: never; }>;


export type ListCampaignsQuery = { __typename?: 'Query', campaigns: Array<{ __typename?: 'Campaign', id: string, name: string, gmInspiration: boolean, players: Array<{ __typename?: 'Player', id: string, playerName: string, characterName?: string | null, isGM: boolean, inspiration: number }> }> };
...
export type CampaignSubscription = { __typename?: 'Subscription', campaign?: { __typename?: 'Campaign', id: string, name: string, gmInspiration: boolean, players: Array<{ __typename?: 'Player', id: string, playerName: string, characterName?: string | null, isGM: boolean, inspiration: number }> } | null };
...
export const SaveCampaignDocument = gql`
  ...
  campaign(id: $id) {
    ...
    ${CampaignFragmentDoc}`;
export type SaveCampaignMutationFn = Apollo.MutationFunction<SaveCampaignMutation, SaveCampaignMutationVariables>;
 ...
 * });
 */
export function useSaveCampaignMutation(baseOptions?: Apollo.MutationHookOptions<SaveCampaignMutation, SaveCampaignMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SaveCampaignMutation, SaveCampaignMutationVariables>(SaveCampaignDocument, options);
      }
export type SaveCampaignMutationHookResult = ReturnType<typeof useSaveCampaignMutation>;
export type SaveCampaignMutationResult = Apollo.MutationResult<SaveCampaignMutation>;
export type SaveCampaignMutationOptions = Apollo.BaseMutationOptions<SaveCampaignMutation, SaveCampaignMutationVariables>;
...
export function useSavePlayerMutation(baseOptions?: Apollo.MutationHookOptions<SavePlayerMutation, SavePlayerMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SavePlayerMutation, SavePlayerMutationVariables>(SavePlayerDocument, options);
      }
...
export const SetPlayerInspirationDocument = gql`
  ...
  player(id: $id) {
    ...
    ${PlayerFragmentDoc}`;
export type SetPlayerInspirationMutationFn = Apollo.MutationFunction<SetPlayerInspirationMutation, SetPlayerInspirationMutationVariables>;
 ...
 * });
 */
export function useSetPlayerInspirationMutation(baseOptions?: Apollo.MutationHookOptions<SetPlayerInspirationMutation, SetPlayerInspirationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<SetPlayerInspirationMutation, SetPlayerInspirationMutationVariables>(SetPlayerInspirationDocument, options);
      }
export type SetPlayerInspirationMutationHookResult = ReturnType<typeof useSetPlayerInspirationMutation>;
export type SetPlayerInspirationMutationResult = Apollo.MutationResult<SetPlayerInspirationMutation>;
export type SetPlayerInspirationMutationOptions = Apollo.BaseMutationOptions<SetPlayerInspirationMutation, SetPlayerInspirationMutationVariables>;
